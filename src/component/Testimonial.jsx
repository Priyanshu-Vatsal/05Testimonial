...
function Testimonial(props){
    ...
    return(
        <div className="w-[85vw] md:w-[700px] bg-white flex flex-col justify-center items-center mt-10 p-10 transition-all duration-700
            ...
            <div className="flex items-center justify-center text-3xl mt-7 gap-3 text-violet-400 font-bold">
            ...
            <div className="">
                <button onClick={surpriseHandler} className="bg-violet-500 hover:bg-violet-700 transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white uppercase mt-7">
                    Surprise Me
                </button>
            </div>
        </div>
